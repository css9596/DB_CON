...
class InfiniteScrollDemoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commUtil.setupSourceCodeClick(
            ...
            javaSource = commUtil.readAssetFile(this, "activity/InfiniteScrollDemoActivity.kt"),
            xmlSource = commUtil.readAssetFile(this, "layout/activity_infinite_scroll_demo.xml")
        )
